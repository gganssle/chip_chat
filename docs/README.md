...
| [snowflake-schema.md](snowflake-schema.md) | The seventeen tables in it — the ten columns RFC-001 §04 does not print and why each is unavoidable, the view that refuses to let a visitor-scoped table forget `demo_id`, and why nothing is clustered |
