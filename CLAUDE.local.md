...
**YOU ARE IN: `chip_chat/polecats/jade/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/chip_chat/` (rig root) or other directories

```bash
pwd  # Should show .../polecats/jade
```
...
**Your mail address:** `chip_chat/polecats/jade`
**Your rig:** chip_chat
**Your Witness:** `chip_chat/witness`
...
1. Announce: "Polecat jade, checking in."
2. Run: `gt prime`
...
| Ask Witness for help | `gt mail send chip_chat/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`chip_chat/witness`) when:
...
```bash
gt mail send chip_chat/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
